...
const CourseHome = ({ courseId }) => {
    ...
    if (!data) {
        return <div style={{ padding: 48, textAlign: 'center', color: '#64748b' }}>课程信息加载中...</div>;
    }
        ...
        <div style={{
            ...
            <div className="auth-card" style={{ width: '100%' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    <div className="neumorphic-item">
                        <Text style={{ color: '#888', fontWeight: 500 }}>授课教师</Text>
                        <Space style={{ marginTop: 6 }}>
                            <UserOutlined style={{ color: '#448dd0', marginLeft: 6 }} />
                            <Text strong style={{ fontSize: 16, color: '#222' }}>{data.teacher.username}</Text>
                        </Space>
                    </div>

                    <div className="neumorphic-item">
                        <Text style={{ color: '#888', fontWeight: 500 }}>已选学生</Text>
                        <Space style={{ marginTop: 6 }}>
                            <TeamOutlined style={{ color: '#448dd0', marginLeft: 6 }} />
                            <Text strong style={{ fontSize: 16, color: '#222' }}>{data.student_count} 人</Text>
                        </Space>
                    </div>

                    <div className="neumorphic-item">
                        <Text style={{ color: '#888', fontWeight: 500 }}>课程简介</Text>
                        <div style={{
                            whiteSpace: 'pre-line',
                            lineHeight: 1.8,
                            color: '#374151',
