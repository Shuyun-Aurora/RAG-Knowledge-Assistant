...
class MineruParser:
    ...
    def _run_mineru_command(
        ...
        def patched_auto_download_and_get_model_root_path(model_enum):
            ...
            if not model_dir:
                raise RuntimeError("MINERU_MODEL_DIR not set")
            return model_dir
        ...
        with mock.patch("sys.exit") as mock_exit:
            client.main(args=args)
            print(f"MinerU CLI 执行完成（返回码：{mock_exit.call_args})")
